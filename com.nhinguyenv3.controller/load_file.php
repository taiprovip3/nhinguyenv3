    ...
    for ($i = 0; $i < $countrow; $i++)
    {
        ...
        echo '
            <div class="col-lg-4 p-3 border text-dark rounded">
                ...
                <p class="text-center"><code>'.$row["name"].'</code></p>
                ...
                <div class="d-flex">
                    ...
                    <div class="col-lg-4">
                        <p class="small">Mô tả: <b>'.$row["description"].'</b></p>
                    </div>
                    <div class="col-lg-4">
                ...
                <a href="./detail_file.php?file_id='.$row["id"].'" class="btn btn-outline-dark btn-lg need-width" role="button">Chi tiết</a>
                </form>
            </div>
        ';
    }
